---
name: "log-invoice-to-tracker"
description: "Extract invoice data from an email, update the tracker, and confirm receipt. Use this skill when the user needs the Log Invoice to Tracker workflow carried out with the declared parameters and safety gates."
---
...
Provenance note: Core actions were observed from the existing procedure document. Approval and threshold routing were inferred from risk and workflow structure.
